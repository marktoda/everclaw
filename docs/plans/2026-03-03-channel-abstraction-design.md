...
export interface InboundMessage {
  recipientId: string;   // "telegram:601870898"
  text: string;
}
...
The adapter owns message splitting internally via a shared `splitMessage(text, maxLen)` utility. Recipient IDs are always prefixed: `telegram:601870898`, `whatsapp:+1234567890`, `slack:C04ABCD`.
